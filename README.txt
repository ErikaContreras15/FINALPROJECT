...
a persistence unit "FINALPROJECTPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "FINALPROJECT/pom.xml":
...
artifact ("FINALPROJECT.war") is already built. You can build
